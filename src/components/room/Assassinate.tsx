  ...
  if (!isAssassin) {
    return (
      <div className="w-full max-w-md mx-auto space-y-4 p-6 text-center">
        <p className="text-2xl font-bold">선 진영이 퀘스트 3개를 성공시켰습니다!</p>
        <p className="text-sm text-neutral-500">암살자가 멀린을 찾고 있습니다...</p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6 p-6">
      <div className="text-center space-y-1">
        <p className="text-2xl font-bold">멀린을 지목하세요</p>
        <p className="text-sm text-neutral-500">멀린을 맞추면 악당이 역전승합니다</p>
      </div>
      ...
      <button
        ...
        onClick={confirm}
        className="w-full rounded-md bg-red-600 text-white py-2.5 font-medium disabled:opacity-50"
      >
